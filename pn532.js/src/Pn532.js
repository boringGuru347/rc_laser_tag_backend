...
export class Pn532FrameNormal extends Pn532Frame {
  ...
  /**
   * Get response data as UTF-8 string
   * @returns {string} UTF-8 decoded string from response data
   */
  getUtf8 () { return this.data.utf8 }

  /**
   * Get response data as ASCII string
   * @returns {string} ASCII string from response data
   */
  getAscii () { return this.data.ascii }

  /**
   * Get response data as text (tries UTF-8, falls back to ASCII)
   * @returns {string} Decoded text string from response data
   */
